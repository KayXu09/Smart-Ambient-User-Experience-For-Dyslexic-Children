...
import 'package:dyslexia/components/category.dart';
import 'package:dyslexia/components/remember_index.dart';
import 'package:dyslexia/components/setting.dart';
import 'package:dyslexia/components/dictionary.dart';
      ...
      bottomNavigationBar: new BottomNavigationBar(
          ...
          items: [
            new BottomNavigationBarItem(
                ...
                title: new Text('Ord',style: new TextStyle(fontSize: 12.0)),
            ),
            new BottomNavigationBarItem(
                icon: new Icon(Icons.g_translate,size: 24.0,),
                title: new Text('Ordbog',style: new TextStyle(fontSize: 12.0)),
            ),
            new BottomNavigationBarItem(
              icon: new Icon(Icons.library_books,size: 24.0,),
              title: new Text('Liste',style: new TextStyle(fontSize: 12.0),),
            ),
            new BottomNavigationBarItem(
              icon: new Icon(Icons.account_circle,size: 24.0,),
              title: new Text('Mine',style: new TextStyle(fontSize: 12.0),),
            ),
          ]
      )
    );
