...
import 'package:dyslexia/components/detail.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:dyslexia/model/db.dart';
import 'dart:async';
  ...
  _checkIsFinish(BuildContext context,int index,bool know) async{
    if(index==widget.prefs.getInt('count')){
      final snackBar = new SnackBar(
        content: new Text('Færdiggjort dagens studieplan',style: new TextStyle(color: Colors.white),textAlign: TextAlign.center,),
      );
                    ...
                    child: new Padding(
                      ...
                      child: new Center(
                        child:  new GestureDetector(
                            ...
                            child: new Text('ved ikke',style: new TextStyle(color: Colors.red,fontSize: 18.0),)
                        ),
                      ),
                    ),
                  )
                    ...
                    child: new Padding(
                      ...
                      child: new Center(
                        child: new GestureDetector(
                            ...
                            child: new Text('ikke sikker',style: new TextStyle(color: Colors.blue,fontSize: 18.0),)
                        ),
                      ),
                    ),
                  )
                    ...
                    child: new Padding(
                      ...
                      child: new Center(
                        child: new GestureDetector(
                            ...
                            child: new Text('ved godt',style: new TextStyle(color: Colors.green,fontSize: 18.0),)
                        ),
                      ),
                    ),
                  )
